...
function ToDoList(){
    ...
    return(
        <div className="main bg-slate-300 max-sm:flex max-sm:flex-col  mt-5 sm:mt-20 xl:mt-24 sm:mr-10 sm:rounded-r-3xl  ">
        ...
        <div className="todolist  min-h-96 pt-5 pb-10  max-sm:flex max-sm:justify-center  ">
            <div className=" flex-row max-sm:flex-col flex-wrap flex justify-start max:sm:justify-center  ">
